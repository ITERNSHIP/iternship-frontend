<template>
  <div class="h-screen my-auto bg-black-gray">
    <div
      ...
      <div class="w-full max-w-md space-y-8">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              class="group relative flex w-full justify-center rounded-md border border-transparent bg-blue-blue py-2 px-4 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
